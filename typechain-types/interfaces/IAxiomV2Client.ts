...
export interface IAxiomV2ClientInterface extends Interface {
  getFunction(
...
export interface IAxiomV2Client extends BaseContract {
  connect(runner?: ContractRunner | null): IAxiomV2Client;
