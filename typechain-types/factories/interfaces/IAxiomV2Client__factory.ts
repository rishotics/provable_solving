...
} from "../../interfaces/IAxiomV2Client";
...
export class IAxiomV2Client__factory {
  ...
  static createInterface(): IAxiomV2ClientInterface {
    return new Interface(_abi) as IAxiomV2ClientInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IAxiomV2Client {
    return new Contract(address, _abi, runner) as unknown as IAxiomV2Client;
  }
}
